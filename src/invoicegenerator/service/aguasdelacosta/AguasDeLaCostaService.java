package invoicegenerator.service.aguasdelacosta;

import invoicegenerator.service.Service;
import java.util.Calendar;

/**
 * Clase que modela el comportamiento del servicio Aguas de la Costa.
 * */
public class AguasDeLaCostaService implements Service {

    /** Referencia de pago*/
    private String paymentReference;
    /** Metros cúbicos de gas consumidos*/
    private int cubicMetersConsumed;
    /** Valor por metro cúbico de agua*/
    private double cubicMeterValue;

    /**Constructor de la clase*/
    public AguasDeLaCostaService() {
        super();
    }

    /**
     * Constructor de la clase.
     * @param cubicMeterValue El valor de los métros cúbicos de agua consumidos.
     **/
    public AguasDeLaCostaService(double cubicMeterValue) {
        this.cubicMeterValue = cubicMeterValue;
    }

    /**
     * Constructor de la clase.
     * @param cubicMeterValue  El valor por metro cúbico de agua.
     * @param cubicMetersConsumed La cantidad de metros cúbicos de agua consumidos.
     **/
    public AguasDeLaCostaService(double cubicMeterValue, int cubicMetersConsumed){
        this.cubicMeterValue = cubicMeterValue;
     ...
     * @param cubicMetersConsumed La cantidad de metros cúbicos de agua consumidos.
     **/
    public AguasDeLaCostaService(int cubicMetersConsumed){
        this.cubicMetersConsumed = cubicMetersConsumed;
    }
    ...
    public String printInvoice() {
        ...
        invoice.append("***************************************\n");
        invoice.append("*        Aguas de la Costa            *\n");
